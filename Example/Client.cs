        ...
        public static void Run(string[] args)
        {
            ...
            try
            {
                ...
                SingleConnectionCable clientCable =
                    new SingleConnectionCable(new IPEndPoint(IPAddress.Parse(ipAddress), 2500), 1);
                ...
                st.Start();
                double packageCount = Math.Pow(10, 5);
                while (number <= packageCount)
                {
                    Console.WriteLine("Current Number：" + number.ToString());
